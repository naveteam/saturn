...
Quando a prop `progress` chega ao número `100`, a ProgressBar se torna verde, indicando sucesso da operação. Essa cor pode ser trocada por meio da prop successColor.
