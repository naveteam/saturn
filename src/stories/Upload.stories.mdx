...
import { AttachmentComponent, Flex, Typography, Upload, SaturnProvider } from '../components'
      ...
      return (
        <SaturnProvider>
          <Flex justifyContent='space-between' mb={4}>
            <Upload name='button' variant='button' mr={4} />
            <Upload name='buttonWithCaption' variant='button' caption='Caption' mr={4} />
            <Upload name='buttonWithColor' variant='button' caption='Color' color='secondary' />
          </Flex>
          <Flex justifyContent='space-between' mb={4}>
            <Upload
              ...
              mr={4}
            />
            <Upload name='buttonWithMultipleFiles' variant='button' caption='Multiple Files' multipleFiles mr={4} />
            <Upload name='buttonDisabled' variant='button' caption='Disabled' disabled />
          </Flex>
          <Flex justifyContent='space-between' mb={4}>
            <Upload
              ...
              mr={4}
            />
            <Upload name='buttonSecondary' variant='button-secondary' caption='Secondary' mr={4} />
            <Upload name='buttonOutlined' variant='button-outlined' caption='Outlined' color='secondary' />
          </Flex>
        </SaturnProvider>
      )
    }}
        ...
        <SaturnProvider>
          ...
          <Flex justifyContent='space-between' mb={4}>
            ...
            <Upload
              ...
              mr={4}
            />
            <Upload name='dragDropDisabled' variant='drag-drop' description='Drag & Drop disabled' disabled mr={4} />
          </Flex>
        </SaturnProvider>
      )
    }}
  ...
  >
    {() => {
      ...
      return (
        <SaturnProvider>
          <Flex justifyContent='space-between' mb={4}>
            <Upload name='imageUpload' variant='image' mr={4} />
            <Upload name='imageWithColor' variant='image' caption='Color' color='secondary' mr={4} />
            <Upload name='imageWithColor' variant='image' caption='Disabled' disabled mr={4} />
          </Flex>
        </SaturnProvider>
      )
    }}
